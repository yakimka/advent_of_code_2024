...
def _check(test_value: int, numbers: list[int]) -> bool:
    ...
    return (
        _check(test_value, [first * second, *other])
        or _check(test_value, [first + second, *other])
        or _check(test_value, [int(str(first) + str(second)), *other])
    )
